...
class FileServiceImpl(
    ...
    override fun getFile(fileId: String): File {
        ...
        return File("C:\\Desktop\\Diplom\\fileService\\src\\main\\resources\\uploadedFiles\\${fileDescriptor.fileFullName}")
    }
    ...
    override fun uploadFile(file: MultipartFile, userId: String): FileDescriptor {
        ...
        try {
            val out = BufferedOutputStream(
                FileOutputStream(
                    File(
                        "C:\\Desktop\\Diplom\\fileService\\src\\main\\resources\\uploadedFiles\\$fileInStorageName"
                    )
                )
            )
